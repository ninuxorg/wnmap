...
define ("SHOW_ACTIVEIPV4_NODES","Visualizza nodi attivi IPv4");
define ("SHOW_ACTIVEIPV6_NODES","Visualizza nodi attivi IPv6");
define ("SHOW_POTENTIAL_NODES","Visualizza nodi potenziali");
define ("SHOW_HOTSPOT_NODES","Visualizza HotSpot");
define ("SHOW_WIRELESS_LINKS","Visualizza collegamenti wireless");
define ("SHOW_INTERNET_TUNNELS","Visualizza tunnel VPN");
define ("NODES_","Nodi");
...
define ("NODE_TYPE_","Tipo di nodo:");
define ("NODE_TYPE_DESC","Definisci il tipo di nodo che vuoi installare: Potenziale (Antenna su tetto), HotSpot o VPN");
